      ...
      <div className="px-[5%] lg:px-[10%] py-20 mt-10">
                ...
                <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-50 transition">
                  <td className="py-4 px-4 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="w-24 sm:w-20 md:w-24 lg:w-[15%] object-cover rounded"
                    />
                  ...
                  <td className="py-4 px-4">
                    <div className="w-fit flex flex-col md:flex-row border border-transparent md:border-gray-200 rounded-lg items-center justify-between gap-2">
                      <button
                        ...
                        className="px-4 py-1 text-2xl rounded md:rounded-none cursor-pointer bg-gray-100 hover:bg-gray-200 transition-all duratipn-300"
                      >
                        -
                      </button>
                  ...
                  <td className="py-4 px-4">
                    <button
                      ...
                      className="px-3 py-1 bg-red-500 cursor-pointer text-white rounded hover:bg-red-600 flex items-center gap-2 text-sm sm:text-base"
                    >
                      <Icon
                        icon="mdi:delete"
                        width="20"
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-6 lg:gap-10 mt-20">
          <div className="lg:w-2/3">
            <h2 className="text-3xl font-semibold mb-4 Exo">Yo may also like</h2>
            ...
            >
              {RandomProductData.map((item, index) => (
          ...
          <div className="lg:w-1/3 rounded-lg lg:sticky top-20 left-0 h-full">
            ...
            <div className="grid grid-cols-2 border boder-gray-200 rounded-lg overflow-hidden">
            ...
            <Link href={`/Pages/Checkout`}>
              <button className="w-full mt-5 px-6 py-3 Exo font-semibold cursor-pointer bg-black text-white rounded hover:bg-gray-800 transition-all duration-300">
                Proceed To Checkout
              </button>
            </Link>
          </div>
