    ...
    <>
      <div className='px-[5%] lg:px-[10%] py-10 lg:py-20'>
        <div className='banner'>
          <div className='banner-content flex items-center h-full px-[5%]'>
            <div className=''>
              <h2 className='Exo text-5xl md:text-6xl font-semibold text-gray-800'>
                LEISURE IN STYLE
              </h2>

              <p className='Exto text-lg text-gray-600 my-2'>
