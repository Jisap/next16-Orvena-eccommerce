...
const ProductDetails = () => {
  ...
  const { id } = params;
  const product = WomensProductData.find((product) => product.id.toString() === id);
    ...
    <>
      ...
      <div className='px-[5%] lg:px-[10%] py-20 pt-20 flex flex-col lg:flex-row gap-10 border-b border-gray-300'>
        ...
        <div className='w-full lg:w-1/2 flex flex-col gap-5'>
          ...
          <p>
            Categories: Active, Fashion Hoodies & Sweatsshirts, Jackets & Coats, Jeans, Women Clothing, Pants, Shirts,
